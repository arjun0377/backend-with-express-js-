...
const getUserChannelProfile = asynchandler(async (req, res) => {
    ...
    return res
        .status(200)
        .json(
            new apiresponse(200, userChannel[0], "the suercahnnel is fetched successfully ")
        )
})


const userWatchHistroy = asynchandler(async (req, res) => {
    const user = await User.aggregate([
      ...
      .status(200)
      .json(
        new apiresponse(200 ,user[0].watchHistroy , " watch History fetech succesfully  ")
      )
})
